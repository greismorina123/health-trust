...
const Search = () => {
  ...
  // Lazy-load districts when entering desert mode
  useEffect(() => {
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16 pb-16 px-4 sm:px-6 max-w-5xl mx-auto">
        ...
        <form onSubmit={submit} className="fade-up">
          ...
          {/* Example chips — hidden after first submit */}
          {!submittedQuery && (
        ...
        {submittedQuery && reasoningSteps.length > 0 && (
          <div className="mt-6 rounded-xl border border-border-subtle bg-panel overflow-hidden fade-up">
            <button
        ...
        {/* Selected facility detail + inline map (full-screen overlay) */}
        {selected && (
                ...
                {showMap && (
                  <div className="bg-panel border border-border-subtle rounded-xl overflow-hidden h-[60vh] lg:h-[calc(100vh-140px)] sticky top-16">
                    ...
                    <div className="relative w-full h-[calc(100%-40px)]">
                      ...
                      />
                      {mapMode === "deserts" && districtsLoading && (
                        <div className="absolute top-3 left-3 inline-flex items-center gap-1.5 rounded-md bg-panel-elevated/80 backdrop-blur px-2 py-1 text-[11px] text-muted-foreground">
